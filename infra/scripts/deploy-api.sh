...
yc serverless function version create \
  ...
  --environment "APP_URL=${APP_URL:-https://app.xn--80aaxzavh.xn--p1ai}" \
  --environment "API_URL=${API_URL:-https://api.xn--80aaxzavh.xn--p1ai}" \
  --environment "YOOKASSA_RETURN_URL=${YOOKASSA_RETURN_URL:-https://app.xn--80aaxzavh.xn--p1ai/billing/success}" \
